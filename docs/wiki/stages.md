...
transitions are evidence-driven: the [research streams](../../research/README.md)
(run via the `/tech-research` and `/learning-research` skills) maintain dated
histories of tech-capability and learning-science reports, and their
recommendations feed this page. Each stage raises the LLM's responsibility;
the safety contract never changes:
